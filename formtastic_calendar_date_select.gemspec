...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<formtastic>, [">= 0", "= 0.9.10"])
      s.add_runtime_dependency(%q<calendar_date_select>, [">= 0", "= 1.16.1"])
    else
      s.add_dependency(%q<formtastic>, [">= 0", "= 0.9.7"])
      s.add_dependency(%q<calendar_date_select>, [">= 0", "= 1.16.1"])
    end
  else
    s.add_dependency(%q<formtastic>, [">= 0", "= 0.9.10"])
    s.add_dependency(%q<calendar_date_select>, [">= 0", "= 1.16.1"])
  end
end
